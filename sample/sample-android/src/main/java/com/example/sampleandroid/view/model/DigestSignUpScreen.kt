...
import kim.jeonghyeon.sample.viewmodel.DigestSignUpViewModel

class DigestSignUpScreen(val onSignedUp: () -> Unit, private val model: DigestSignUpViewModel = DigestSignUpViewModel(onSignedUp)) : ModelScreen(model) {
