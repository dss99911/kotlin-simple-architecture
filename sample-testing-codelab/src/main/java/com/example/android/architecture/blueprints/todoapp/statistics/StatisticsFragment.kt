 ...
 */
class StatisticsFragment : MvvmFragment<StatisticsViewModel, StatisticsFragBinding>() {

    override val viewModel: StatisticsViewModel by simpleViewModels { StatisticsViewModel() }
