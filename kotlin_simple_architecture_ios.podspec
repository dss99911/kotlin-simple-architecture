#
#  Be sure to run `pod spec lint kotlin_simple_architecture_ios.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Jeonghyeon Kim" => "dss99911@gmail.com" }
  # Or just: spec.author    = "Hyun"
  # spec.authors            = { "Hyun" => "hyun@balancehero.com" }
  # spec.social_media_url   = "https://twitter.com/Hyun"
  ...
  spec.source       = { :git => "https://github.com/dss99911/kotlin-simple-architecture.git", :tag => "#{spec.version}" }
