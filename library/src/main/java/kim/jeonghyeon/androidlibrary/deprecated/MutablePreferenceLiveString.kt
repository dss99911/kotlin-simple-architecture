...
@Suppress("unused")
class MutablePreferenceLiveString(private val key: String, private val defValue: String? = null) : BaseMutableLiveData<String>(), Observer<String>, SharedPreferences.OnSharedPreferenceChangeListener {
